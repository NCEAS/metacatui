...
define(['jquery',
	...
	var DataCatalogView = Backbone.View.extend({
		...
		markerImage: './js/themes/dataone/img/markers/map-marker.png',
		
		markerImageAlt: './js/themes/dataone/img/markers/orangered-enlarged-marker.png',
		
		markerImage15: './js/themes/dataone/img/markers/marker-15px-25a.png',
		
		markerImage20: './js/themes/dataone/img/markers/marker-20px-25a.png',
		
		markerImage30: './js/themes/dataone/img/markers/marker-30px-25a.png',
		
		markerImage40: './js/themes/dataone/img/markers/marker-40px-25a.png',
		
		markerImage50: './js/themes/dataone/img/markers/marker-50px-25a.png',
		
		markerImage60: './js/themes/dataone/img/markers/marker-60px-25a.png',
