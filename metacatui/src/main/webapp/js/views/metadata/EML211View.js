    ...
    function (_, $, Backbone, ScienceMetadataView, EML, EMLText, EMLTemporalCoverage, Template, OverviewTemplate) {
        var EMLView = ScienceMetadataView.extend({
            ...
            updateText: function (e) {
                console.log('before', this.model.get('abstract'));
                ...
                if (!textModel) {
                    console.log('not textmodel', category)
                ...
                console.log('after', this.model.get('abstract'));

            },

            // Update an EMLTemporalCoverage instance
            updateTemporalCoverage: function (e) {
                console.log('updateTemporalCoverage');
                ...
                if (!model) {
                    ...
                    this.model.set('temporalCoverage', 
                                   this.model.get('temporalCoverage').concat(model));
