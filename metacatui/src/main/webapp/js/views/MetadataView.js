	...
	var MetadataView = Backbone.View.extend({
		...
		getProvenance: function(doc){
			...
			function makeLink(id){
				return "<a href='" + appModel.get('objectServiceUrl') + encodeURIComponent(id) + "'>" + id + "</a>"; 
			}
			
			if(doc.wasDerivedFrom && doc.wasGeneratedBy){
				prov += "This data was derived from ";
				_.each(doc.wasDerivedFrom, function(obj){
					prov += makeLink(obj) + " ";
				});
				prov += " and was generated by ";
				_.each(doc.wasGeneratedBy, function(obj){
					prov +=  makeLink(obj) + " ";
				});
				prov += ". ";
			}
				...
				prov += "This data was generated by ";
				_.each(doc.wasGeneratedBy, function(obj){
					prov +=  makeLink(obj) + " ";
				});
				prov += ". ";
			...
			if(doc.wasInformedBy){
				...
				_.each(doc.wasInformedBy, function(obj){
					prov +=  makeLink(obj) + " ";
				});
				prov += ". ";
			}
