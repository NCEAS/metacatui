...
define(['jquery',
	...
	function($, $ui, Annotator, _, Backbone, gmaps, fancybox, MetadataIndex, ExpandCollapseList, PublishDoiTemplate, VersionTemplate, LoadingTemplate, UsageTemplate, DownloadContentsTemplate, AlertTemplate, EditMetadataTemplate, DataDisplayTemplate, MapTemplate) {
	'use strict';
	...
	var MetadataView = Backbone.View.extend({
		...
		insertVisuals: function(visuals, type){
			...
			for(var i=0; i<visuals.length; i++){
				...
				//Insert the collapsable list of object IDs
		...
		getProvenance: function(doc){
			...
			if(doc.wasDerivedFrom && doc.wasGeneratedBy){
				...
				prov += "This " + noun + " was generated by " +
						wasGeneratedBy.render().$el.html() +
						". ";
			}
			...
			if(doc.wasInformedBy){
				...
				prov += "This program was generated by " +
						wasInformedBy.render().$el.html() +
						". ";
			}
