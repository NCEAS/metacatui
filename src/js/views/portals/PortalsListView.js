define(["jquery",
    ...
    "views/PagerView",
    "text!templates/portals/portalsList.html"],
    function($, _, Backbone, Filters, SearchResults, PagerView, Template){

      /**
      * @class PortalsListView
      ...
      */
      return Backbone.View.extend(
        /** @lends PortalsListView.prototype */{
        ...
        */
        ...
        /**
        /**
        * The number of portals to retrieve 
        * @default 100
        * @type {number}
        */
        numPortals: 100,
        ...
        /**
        /**
        * The number of portals to display (for each paged result)
        * @default 100
        * @type {number}
        */
        portalsPerPage: 3,
        ...
        * @param (String) - The DOM element id to display the results in-
        * @param (Boolean) - Does the user have permission to edit the displayed portal-
        * @param (Number) - The number of portals to display (for each paged result)-
        * 
        */
