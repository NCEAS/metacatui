      ...
      /** @lends QueryRuleView.prototype */
      {
        ...
        initialize: function(options) {
          try {
            ...
            if (!this.model || !this.model.collection) {
              console.error("error: A Filter model that's part of a Filters collection is required to initialize a Query Rule view.")
              return
            }
        ...
        addFieldSelect: function() {
          ...
          try {
            ...
            console.error("Error adding a metadata selector input in the Query Rule View, error message:", e);
          }
        },
        ...
        handleFieldChange: function(newFields){
          ...
          try {
            ...
            console.error("Failed to handle query field change in the Query Rule View, error message: " + e);
          }
        ...
        getRequiredFilterType: function(fields){
          try {
            ...
            console.error("Failed to detect the required filter type in the Query Rule View, error message: " + e);
          }
        },
        ...
        addOperatorSelect: function(selectedOperator) {
          try {
            ...
            console.error("Error adding an operator selector input in the Query Rule View, error message:", e);
          }
        },
        ...
        handleOperatorChange: function(newOperatorLabel){
          try {
            ...
            console.error("Failed to handle the operator selection in a query rule view, error message: " + e);
          }
        },
        ...
        getSelectedOperator: function(){
          ...
          try{
            ...
            console.error("Failed to select an operator in the Query Rule View, error message: " + e);
          }
        },
        ...
        getCategory: function(fields){
          ...
          try {
            ...
            console.error("Failed to detect the category for a group of filters in the Query Rule View, error message: " + e);
          }
        ...
        addValueSelect: function() {
          try {
            ...
            console.error("Error adding a search value input in the Query Rule View, error message:", e);
          }
        },
        ...
        handleValueChange: function(newValues){
          ...
          try {
            ...
            console.error("Failed to handle a change in select values in the Query Ryle View, error message: " + e);
          }
        },
          ...
          try {
            ...
            switch (inputType) {
              ...
              case "field":
                ...
                break;
              default:
                console.error("Must specify either value, operator, or field in the removeInput function in the Query Rule View")
            }
          } catch (e) {
            console.error("Error removing an input from the Query Rule View, error message:", e);
          }
        },
