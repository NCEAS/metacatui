...
define([
  ...
  var SearchResultView = Backbone.View.extend({
    ...
    metricStatTemplate: _.template(
      "<span class='catalog badge'> <i class='catalog-metric-icon " +
    ...
    displayMetrics: function () {
      ...
      if (citationCount == 1) {
        ...
        var citationToolTip =
          MetacatUI.appView.numberAbbreviator(citationCount, 1) + " citations";
      }
      ...
      if (downloadCount == 1) {
        ...
        var downloadToolTip =
          MetacatUI.appView.numberAbbreviator(downloadCount, 1) + " downloads";
      }
      ...
      this.$(".resultItem-CitationCount")
        .html(
          this.metricStatTemplate({
            metricValue: MetacatUI.appView.numberAbbreviator(citationCount, 1),
      ...
      this.$(".resultItem-DownloadCount")
        .html(
          this.metricStatTemplate({
            metricValue: MetacatUI.appView.numberAbbreviator(downloadCount, 1),
