    ...
    /** @lends Accordion.prototype */
    {
      ...
      defaults() {
        return {
          ...
          collapsible: true,
          duration: 300,
          // TODO: test and implement these callbacks
          // onOpening: function (activeContent) { }, // TODO: CONTEXT (this) is activeContent, I don't know what's passed in
          // onOpen: function (activeContent) { },
          // onClosing: function (activeContent) { },
          // onClose: function (activeContent) { },
          // onChanging: function (activeContent) { },
          // onChange: function (activeContent) { },
          styled: true,
          inverted: false,
          fluid: true,
        };
