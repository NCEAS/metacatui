  ...
  var MapModel = Backbone.Model.extend(
    /** @lends MapModel.prototype */ {
      ...
      initialize: function (config) {
        ...
        console.log("show zoom presets?", config);
        this.set('showZoomPresets', true);
        config.zoomPresets = [
          {
            title: 'Brevig Mission',
            latitude: 65.3381235,
            longitude: -166.49594395,
            height: 5000,
            description: 'Report to LEO of ground sinking at historic mass burial site',
            layerIds: ['otm', 'iwphir', 'lns', 'goober'],
          },
          {
            title: 'Golovin',
            latitude: 64.56122491,
            longitude: -163.00985255,
            height: 5000,
          ...
          },
          {
            ...
            layerIds: ['osm', 'iwphir', 'lns'],
          },
          {
            title: 'Kotzebue',
            latitude: 66.90537742,
            longitude: -162.5112918,
            height: 5000,
