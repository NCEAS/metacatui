  ...
  var MapModel = Backbone.Model.extend(
    /** @lends MapModel.prototype */ {
      ...
      initialize: function (config) {
        ...
        // TODO(ianguerin): remove this custom configuration.
        this.set('showZoomPresets', true);
        config.zoomPresets = [
          {
          ...
          },
          {
            ...
            height: 10000,
            description: 'Erosion has been an ongoing challenge in the community in the Norton Sound region of Alaska. Numerous pieces of infrastructure have been impacted, including roads, gravesites, the community&rsquo;s former dumpsite, and an abandoned fish processing facility.',
            layerIds: ['ls', 'osm'],
          },
          {
            title: 'Kivalina',
          ...
          },
          {
            ...
            layerIds: ['iwplmir', 'iwphir', 'pe', 'ls', 'otm'],
          },
          {
            title: 'Newtok',
            ...
            height: 300000,
            description: 'This coastal river community has experienced severe riverbank erosion that has impacted transportation infrastructure, power poles, and the community&rsquo;s school and landfill.',
            layerIds: ['iwplmir', 'ls', 'osm'],
          },
          {
            title: 'Noatak',
