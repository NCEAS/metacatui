...
function ($, _, Backbone) {
  ...
  */
    ...
    */
         ...
         */
        renderPortalsList: function() {
            require(['views/portals/PortalsListView'], function(PortalsList){
                MetacatUI.appView.portalsList = new PortalsList({ el: "#Content", fullPage: true});
