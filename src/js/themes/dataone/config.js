...
MetacatUI.AppConfig = Object.assign(
  {
    ...
    portalDefaults: {
      sections: [{ label: "About", title: "About our project" }],
      newPortalActiveSectionLabel: "About",
      sectionImageIdentifiers: [
        "urn:uuid:2cf173b9-4d95-4832-b1c0-bcc6b467343a",
        "urn:uuid:5669b72e-1124-4afa-9b44-3ebd61801753",
        "urn:uuid:4514ef43-a0a3-4d21-a428-ba38ae706bad",
        "urn:uuid:241afa07-82a0-4522-abf5-e7614fc8dfb6",
        "urn:uuid:dbd8645e-9200-431e-8e46-350984730cc2",
      ],
      primaryColor: "#16acc0",
    ...
    dataonePlusPreviewPortals: [
      ...
      {
        seriesId: "urn:uuid:4744e925-6237-4b78-a317-08235e3d0a6d",
        datasource: "urn:node:mnUCSB1",
        label: "rwsc",
      },
    ],
...
MetacatUI.themeMap = {
  "*": {
    ...
    "templates/navbar.html":
      ...
      "/js/themes/" +
      MetacatUI.theme +
      "/components/d1website/navbar.html",
    "templates/footer.html":
      MetacatUI.root +
      "/js/themes/" +
      MetacatUI.theme +
      "/components/d1website/footer.html",
