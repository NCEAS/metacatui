...
return false}}(window.d1Utilities=window.d1Utilities||{}));try{var toggleCalendarMenu=function(button){if(button){var open=JSON.parse(button.getAttribute("aria-expanded"));menuEl=button.parentNode.querySelector("#calendar-menu");d1Utilities.toggleElement(button,menuEl,open);}};}catch(e){console.log('error in: themes/dataone/layouts/partials/blocks/button/button--add2cal.js, error message:'+e)}try{(function(d1_globalHeader,undefined){var block=d1_globalHeader;const
