...
tokenUrl="https://cn.dataone.org/portal/token",isMCUI=typeof MetacatUI!=='undefined',urlMCUI="https://search.dataone.org",baseUrl="https://dataone.org",subLinkTextSelector=".d1_menu-item__sub-item-name";var lastScroll=0,closeDropdownTimeout=0;block.initialize=function(){selectElements();setListeners();if(getUserData()){updateProfileMenu()}
