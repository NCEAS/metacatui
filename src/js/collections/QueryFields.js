  ...
  function($, _, Backbone, X2JS, QueryField) {
    ...
    var QueryFields = Backbone.Collection.extend(
      /** @lends QueryFields.prototype */
      {
        ...
        /**        
         * initialize - Function to execute when a new QueryFields collection is created
         */         
        ...
        */
        ...
        /**        
         * selectSearchableSubset - Filter out fields that aren't searchable or
         * that aren't returnable and return the simplified list
         *          
         * @return {type}  description         
         */         
        selectSearchableSubset: function(){
          // TODO
        }
