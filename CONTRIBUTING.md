...
8. **Develop your features or bug fixes.** Refresh your browser to see the
   changes in action.
9. **Format your code** automatically using `npm run format`.
10. **Lint your changes** using `npx eslint your-changed-file.js` and address any
    issues.
11. **Run unit tests** with `npm test` to ensure all tests pass, including any
    new tests you add for your functionality.
12. **Check that the doc site will build** using `npm run jsdoc-dry-run` to make
    sure there are no JSDoc warnings.
13. **Commit your changes** and push your branch to your forked repository.
