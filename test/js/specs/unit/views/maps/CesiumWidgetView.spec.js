  ...
  describe("CesiumWidgetView Test Suite", () => {
    ...
    describe("render", () => {
      ...
      it("sorts imagery by the order of layers in map", () => {
        ...
        expect(state.view.scene.imageryLayers.get(1).imageryProvider).to.equal(
          Cesium.OpenStreetMapImageryProvider,
        );
        expect(state.view.scene.imageryLayers.get(0).imageryProvider).to.equal(
      ...
      it("sorts imagery by the order of layer categories in map", () => {
        ...
        expect(state.view.scene.imageryLayers.get(2).imageryProvider).to.equal(
          Cesium.OpenStreetMapImageryProvider,
        );
        expect(state.view.scene.imageryLayers.get(1).imageryProvider).to.equal(
          Cesium.WebMapServiceImageryProvider,
