  ...
  describe("EMLDateTimeDomain Test Suite", function () {
    ...
    describe(".parse()", function () {
      ...
      it("should return a date time domain object", function () {
        ...
        attributes.dateTimeDomain.bounds[0].minimum.should.equal(
          "2017-01-01T00:00:00",
        );
        attributes.dateTimeDomain.bounds[0].maximum.should.equal(
          "2017-01-31T11:59:59",
        );
        attributes.dateTimeDomain.bounds[1].minimum.should.equal(
          "2017-02-01T00:00:00",
        );
        attributes.dateTimeDomain.bounds[2].maximum.should.equal(
          "2017-03-31T11:59:59",
        );
      });
    });
