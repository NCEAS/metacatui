define([
  "../../../../../../../../src/js/models/metadata/eml211/EMLMethods",
], function (EMLMethods) {
    ...
    describe("Serializing", function () {
      ...
      describe("Has sampling but no methods", function () {
        ...
        it("should have one method step", () => {
          ...
          expect(
            xmlDoc.getElementsByTagName("methodStep")[0].childNodes[0]
              .childNodes[0].textContent,
          ).to.eql("No method step description provided.");
        });
        it("should have a sampling description", () => {
          expect(xmlDoc.getElementsByTagName("sampling")).to.have.lengthOf(1);
          expect(
            xmlDoc.getElementsByTagName("samplingdescription"),
          ).to.have.lengthOf(1);
          expect(
            xmlDoc.getElementsByTagName("samplingdescription")[0].textContent,
          ).to.equal(`This is a paragraph.This is a second.`);
        });
        it("should have a study extent description", () => {
          expect(xmlDoc.getElementsByTagName("studyExtent")).to.have.lengthOf(
            1,
          );
        });
      });
