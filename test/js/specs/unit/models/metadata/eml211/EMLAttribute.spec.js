  ...
  describe("EMLAttribute Test Suite", function () {
    ...
    describe(".parse()", function () {
      ...
      it("should return an attribute definition", function () {
        ...
        attributes.attributeDefinition.should.equal(
      ...
      it("should return storage type and type system arrays", function () {
        ...
        attributes.typeSystem.length.should.equal(
          attributes.storageType.length,
        );
      });
    });
    ...
    describe("For an attribute with nominal measurement scale, .parse()", function () {
      ...
      it("should return a nonNumericDomain array", function () {
        ...
        attributes.measurementScale
          ...
          .should.have.all.keys("textDomain");
      });

      it("should return a textDomain object", function () {
        attributes.measurementScale
          .get("nonNumericDomain")[0]
          .textDomain.should.be.an("object");
        attributes.measurementScale
          .get("nonNumericDomain")[0]
          .textDomain.should.have.all.keys(
            "xmlID",
            "definition",
            "pattern",
            "source",
      ...
      it("should return a textDomain definition string", function () {
        attributes.measurementScale
          .get("nonNumericDomain")[0]
          .textDomain.definition.should.be.a("string");
        attributes.measurementScale
          .get("nonNumericDomain")[0]
          .textDomain.definition.should.equal("Any text");
      });

      it("should return a textDomain pattern array", function () {
        attributes.measurementScale
          .get("nonNumericDomain")[0]
          .textDomain.pattern.should.be.an("array");
        attributes.measurementScale
          .get("nonNumericDomain")[0]
          .textDomain.pattern.length.should.equal(1);
        attributes.measurementScale
          .get("nonNumericDomain")[0]
          .textDomain.pattern[0].should.equal("*");
      ...
      it("should return a textDomain source string", function () {
        attributes.measurementScale
          .get("nonNumericDomain")[0]
          .textDomain.source.should.be.a("string");
        attributes.measurementScale
          .get("nonNumericDomain")[0]
          .textDomain.source.should.equal("Any source");
      });
    });
  });
