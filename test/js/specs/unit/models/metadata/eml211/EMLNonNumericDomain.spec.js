define([
  ...
  describe("EMLNonNumericDomain Test Suite", function () {
    ...
    before(function () {
      ...
      enumDomainCodeDefXML =
        NonNumericDomainUtil.getTestOrdinalEnumeratedCodeDefinitionDomainXML();
    ...
    describe("For a nominal scale with a text domain, .parse()", function () {
      ...
      it("should return a textDomain object", function () {
        ...
        textDomainAttrs.nonNumericDomain[0].textDomain.should.have.all.keys(
          "xmlID",
          "definition",
          "pattern",
          "source",
      ...
      it("should return a textDomain definition string", function () {
        textDomainAttrs.nonNumericDomain[0].textDomain.definition.should.be.a(
          "string",
        );
        textDomainAttrs.nonNumericDomain[0].textDomain.definition.should.equal(
          "Any text",
        );
      });

      it("should return a textDomain pattern array", function () {
        textDomainAttrs.nonNumericDomain[0].textDomain.pattern.should.be.an(
          "array",
        );
        textDomainAttrs.nonNumericDomain[0].textDomain.pattern.length.should.equal(
          1,
        );
      ...
      it("should return a textDomain source string", function () {
        textDomainAttrs.nonNumericDomain[0].textDomain.source.should.be.a(
          "string",
        );
        textDomainAttrs.nonNumericDomain[0].textDomain.source.should.equal(
          "Any source",
        );
      });
    });
    ...
    describe("For a nominal scale with a text domain, updateDOM()", function () {
      ...
      it("should update the text domain definition", function () {
        $(updatedDOM)
          ...
          .children("textdomain")
          .children("definition")[0]
          .textContent.should.equal("Another definition");
      });
      ...
      it("should update the text domain pattern", function () {
        $(updatedDOM)
          ...
          .children("textdomain")
          .children("pattern")[0]
          .textContent.should.equal("{0-9}{0-9}{0-9}");
      });
    });
    ...
    describe("For an ordinal scale with an enumerated domain code definition, .parse()", function () {
      ...
      it("should return a nonNumericDomain object", function () {
        ...
        enumDomainCodeDefAttrs.nonNumericDomain[0].should.have.all.keys(
          "enumeratedDomain",
        );
      });

      it("should return an enumeratedDomain object", function () {
        enumDomainCodeDefAttrs.nonNumericDomain[0].enumeratedDomain.should.be.an(
          "object",
        );
        enumDomainCodeDefAttrs.nonNumericDomain[0].enumeratedDomain.should.have.all.keys(
          "codeDefinition",
          "xmlID",
        );
      });
      ...
      it("should return an enumeratedDomain codeDefinition array ", function () {
        enumDomainCodeDefAttrs.nonNumericDomain[0].enumeratedDomain.codeDefinition.should.be.an(
          "array",
        );
        enumDomainCodeDefAttrs.nonNumericDomain[0].enumeratedDomain.codeDefinition.length.should.equal(
          2,
        );
        enumDomainCodeDefAttrs.nonNumericDomain[0].enumeratedDomain.codeDefinition[0].should.be.an(
          "object",
        );
        enumDomainCodeDefAttrs.nonNumericDomain[0].enumeratedDomain.codeDefinition[0].should.have.all.keys(
          "code",
          "definition",
          "source",
        );
        enumDomainCodeDefAttrs.nonNumericDomain[0].enumeratedDomain.codeDefinition[0].code.should.equal(
          "JAL",
        );
        enumDomainCodeDefAttrs.nonNumericDomain[0].enumeratedDomain.codeDefinition[0].definition.should.equal(
          "Jalama Beach, California",
        );
        enumDomainCodeDefAttrs.nonNumericDomain[0].enumeratedDomain.codeDefinition[0].source.should.equal(
          "USGS Place Name Gazateer",
        );
        enumDomainCodeDefAttrs.nonNumericDomain[0].enumeratedDomain.codeDefinition[1].code.should.equal(
          "ALE",
        );
        enumDomainCodeDefAttrs.nonNumericDomain[0].enumeratedDomain.codeDefinition[1].definition.should.equal(
          "Alegria, California",
        );
        expect(
          enumDomainCodeDefAttrs.nonNumericDomain[0].enumeratedDomain
            .codeDefinition[1].source,
        ).to.not.exist;
      });
    });
  });
