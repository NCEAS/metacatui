define(["../../../../../../../../src/js/models/filters/Filter"], function (
  Filter,
) {
  ...
  describe("Filter Test Suite", function () {
    ...
    describe("Constructing queries", function () {
      it("should query for multiple terms", function () {
        ...
        filter
          .getQuery()
          .should.equal('origin:("Bart%20Simpson"%20OR%20George)');
      });
      ...
      it("should query for multiple fields", function () {
        ...
        filter
          .getQuery()
          .should.equal(
            "(keyword:*ocean*%20AND%20title:*ocean*%20AND%20abstract:*ocean*)",
          );
      });
      ...
      it("should wrap phrases in quotes", function () {
        ...
        filter
          .getQuery()
          .should.equal('origin:"This%20is%20a%20phrase%20with%20spaces"');
      });
      ...
      it("should wrap ids in quotes", function () {
        ...
        filter
          .getQuery()
          .should.equal(
            'id:"urn%5C%3Auuid%5C%3A06e43be7%5C-f3fb%5C-43b9%5C-b45c%5C-0969880495fb"',
          );
        filter.set({
          fields: ["abstract"],
          values: ["urn:uuid:06e43be7-f3fb-43b9-b45c-0969880495fb"],
        ...
        filter
          .getQuery()
          .should.equal(
            'abstract:"urn%5C%3Auuid%5C%3A06e43be7%5C-f3fb%5C-43b9%5C-b45c%5C-0969880495fb"',
          );
      });
      ...
      it("should wrap group and person subjects in quotes", function () {
        ...
        filter
          .getQuery()
          .should.equal(
            'submitter:("CN%3Dknb%5C-data%5C-admins%2CDC%3Ddataone%2CDC%3Dorg"%20OR%20"http%5C%3A%5C%2F%5C%2Forcid.org%5C%2F0000%5C-0003%5C-2192%5C-431X")',
          );
      });
      ...
      it("should encode queries", function () {
        ...
        filter
          .getQuery()
          .should.equal(
            'keyword:("%5C%2B%20%5C-%20%20%5C%7C%5C%7C%20%5C!%20%5C(%20%5C)%20%5C%7B%20%5C%7D%20%5C%5B%20%5C%5D%20%5C%5E%20%5C%22%20%5C~%20*%20%5C%3F%20%5C%3A%20%5C%2F"%20AND%20"CN%3Dknb%5C-data%5C-admins%2CDC%3Ddataone%2CDC%3Dorg"%20AND%20nothingtoencode%20AND%20)',
          );
      });
    });
    ...
    describe("Utilities", function () {
      ...
      it("should recognize id filters", function () {
        ...
        filter.isIdFilter().should.be.true;
        filter.set("values", [
          "doi:10.5072/FK2PZ5943J",
          "https://dx.doi.org/10.5072/FK2PZ5943J",
        ]);
        filter.isIdFilter().should.be.true;
      });
    });
